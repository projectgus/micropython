...
Over twenty different MicroPython ports are provided in this repo, split across three [MicroPython Support Tiers](https://docs.micropython.org/en/latest/develop/support_tiers.html):

Tier 1 Ports
============

👑 This [Tier](https://docs.micropython.org/en/latest/develop/support_tiers.html) has the most active development, support and testing:

| Port                     | Target                                                                        | Quick Reference                                                              |
|--------------------------|-------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [esp32](ports/esp32)     | Espressif ESP32 SoC (including ESP32S2, ESP32S3, ESP32C3, ESP32C6).           | [here](https://docs.micropython.org/en/latest/esp32/quickref.html)           |
| [mimxrt](ports/mimxrt)   | NXP m.iMX RT (including Teensy 4.x).                                          | [here](https://docs.micropython.org/en/latest/mimxrt/quickref.html)          |
| [rp2](ports/rp2)         | Raspberry Pi RP2040 (including Pico and Pico W).                              | [here](https://docs.micropython.org/en/latest/rp2/quickref.html)             |
| [samd](ports/samd)       | Microchip (formerly Atmel) SAMD21 and SAMD51.                                 | [here](https://docs.micropython.org/en/latest/samd/quickref.html)            |
| [stm32](ports/stm32)     | STMicroelectronics STM32 microcontrollers (many families, including PyBoard). | [For PyBoard](https://docs.micropython.org/en/latest/pyboard/quickref.html#) |
...
✔️ This [Tier](https://docs.micropython.org/en/latest/develop/support_tiers.html) is less actively developed and tested than Tier 1, but still fully supported:
...
Ports in this [Tier](https://docs.micropython.org/en/latest/develop/support_tiers.html) are built in CI but not regularly tested by the MicroPython maintainers:
...
MicroPython port and can be compiled as both a standalone Linux binary as well
as for ARM Cortex M4. Start with this if you want to port MicroPython to another
microcontroller.
* The ["bare-arm"](ports/bare-arm) port is an example of the absolute minimum
configuration, and is used to keep track of the code size of the core runtime
and VM.
